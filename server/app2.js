...
app.get('/followers/:twitterUser', function(req, res) {
    ...
    if (offline) {
        ...
        fs.readFile(path, "utf-8", function(err, data) {
            ...
            var followers = CreateTweetObjects(data);
        ...
        client.get('followers/list.json', {
            ...
            //localJSON = response;
            var followers = CreateTweetObjects(response);
            ...
            // for dummy local JSON file creation - do not touch
            // var path = __dirname + "/dummyData/dummy.JSON";
...
function CreateTweetObjects(data) {
    var followers = [];
